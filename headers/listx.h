...
/*
    ...
    Di base si usa quando voglio dichiarare e inizializzare subito una struttura
*/
...
/*
    ...
    Di base si una quando la variabile è già presente e voglio inizializzarla in seguito
*/
